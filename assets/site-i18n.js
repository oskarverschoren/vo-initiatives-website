...
(function () {
  ...
  const DICT = {
    en: {
      ...
      "nav.dash": `My dashboard`, "foot2.l4": `My dashboard`,
      ...
      "wfs.lead": `Nine examples of what a VOI Agent runs end to end — built on your processes.`,
      ...
      "wf7.tag": `Marketing`, "wf7.t": `Social media & content`, "wf7.p": `Posts written in your voice, scheduled and followed up. Every week, without you thinking about it.`,
      "wf8.tag": `Custom`, "wf8.t": `Builds its own integrations`, "wf8.p": `Missing a connection to your software? Your agent builds it itself — it's simply part of the service.`,
      "wf9.tag": `Legacy`, "wf9.t": `Works inside your old software`, "wf9.p": `No integration possible? Your agent takes over the screen and works in your familiar programs, like a colleague would.`,
      ...
      "dash.conn.ok": `Connected`, "dash.conn.saved": `Key stored`,
      "dash.conn.replace": `Click to replace or reconnect`,
      "dash.conn.add": `Add a tool`, "dash.conn.addname": `Name of the tool`, "dash.conn.next": `Next`,
      "dash.wiz.test": `Test & connect`, "dash.wiz.testing": `Testing…`,
      "dash.wiz.err": `Connecting failed — try again.`,
      "dash.wiz.email": `Email address`, "dash.wiz.apppw": `App password`,
      "dash.wiz.ics": `Secret iCal/ICS link`, "dash.wiz.apikey": `API key`,
      "dash.wiz.help.gmail": `Use an app password — not your regular password (we never ask for it). 2-step verification must be on. <a href="https://myaccount.google.com/apppasswords" target="_blank" rel="noopener">Create one here →</a>`,
      "dash.wiz.help.outlook": `Use an app password — not your regular password (we never ask for it). <a href="https://account.microsoft.com/security" target="_blank" rel="noopener">Create one here →</a>`,
      "dash.wiz.help.ics": `Paste your calendar's secret iCal link — read-only, we can't change anything. <a href="https://calendar.google.com/calendar/r/settings" target="_blank" rel="noopener">Find it in Google Calendar settings →</a>`,
      "dash.wiz.help.apikey": `Create an API key in this tool with the most limited permissions possible and paste it here. Your agent only uses it for your workflows.`,
      "dash.login.h1": `Open your dashboard`,
      "dash.login.p": `Enter the email address you used for your audit — you'll get a login code right away.`,
      "dash.login.email": `Email address`, "dash.login.send": `Send login code`,
      "dash.login.sent": `If this address is known, an email with your code is on its way (valid for 30 minutes).`,
      "dash.login.code": `Login code (6 digits)`, "dash.login.verify": `Log in`,
      "dash.agent.t2": `Your agent`, "dash.agent.concierge": `Being built`,
      "dash.plan.t": `Your plan`, "dash.plan.portal": `Manage your subscription`,
      "dash.plan.unlimited": `VOI Unlimited — unlimited workflows and cron jobs.`,
      "dash.plan.note": `€{x} of €2,250/m — everything unlimited from there.`,
      "dash.flows.t2": `Workflows`, "dash.flows.hint2": `Activate what your agent may take over`,
      "dash.wf.activate": `Activate`, "dash.wf.active": `Active`, "dash.wf.pm": `/m`,
      "dash.wf.build": `Build & test — free`, "dash.wf.inbuild": `Being built`,
      "dash.wf.review": `Approve & activate`, "dash.wf.live": `Live`,
      "dash.werk.group": `Agent worked — {n} steps`,
      "dash.think.1": `Reading your message…`,
      "dash.think.2": `Thinking…`,
      "dash.think.3": `Writing the answer…`,
      "dash.think.4": `One moment — this is a long one…`,
      "dash.focus.on": `Focused on '{w}'`,
      "dash.focus.ph": `About '{w}': type your message…`,
      "dash.focus.close": `Close focus`,
      "dash.ideas.aria": `Ideas for your agent`,
      "dash.ideas.t": `What do you want to work on?`,
      "dash.ideas.hint": `Click — your agent picks it up in the chat.`,
      "dash.idea1.t": `Follow up quotes`, "dash.idea1.d": `Nothing slips`, "dash.idea1.p": `Build a workflow that automatically follows up my quotes.`,
      "dash.idea2.t": `Process invoices`, "dash.idea2.d": `Read and checked`, "dash.idea2.p": `Build a workflow that processes and checks incoming invoices.`,
      "dash.idea3.t": `Weekly report & KPIs`, "dash.idea3.d": `Ready every Monday`, "dash.idea3.p": `Prepare my weekly report with numbers automatically every Monday.`,
      "dash.idea4.t": `Track & trace`, "dash.idea4.d": `Customers updated automatically`, "dash.idea4.p": `Automatically send customers an update when their order status changes.`,
      "dash.idea5.t": `Leads & appointments`, "dash.idea5.d": `Answered within the half hour`, "dash.idea5.p": `Catch new leads and automatically schedule an appointment.`,
      "dash.idea6.t": `Social media`, "dash.idea6.d": `Posts in your style, ready to approve`, "dash.idea6.p": `Prepare weekly social media posts in our style.`,
      "dash.idea7.t": `Custom integration`, "dash.idea7.d": `Your agent builds it itself`, "dash.idea7.p": `Build an integration with our own software.`,
      "dash.idea8.t": `Legacy software`, "dash.idea8.d": `Works in it like a colleague`, "dash.idea8.p": `Take over tasks in our old software without an integration.`,
      "dash.wf.payopened": `Payment page opened for "{w}" — once payment arrives, it goes live here automatically.`,
      "dash.agent.t": `Chat with your agent`,
      "dash.agent.live": `Live`, "dash.agent.soon": `being activated`,
      "dash.agent.pending": `Your agent is being set up and activated by VOI — the chat will appear here once it's live.`,
      "dash.agent.err": `Your agent is briefly unreachable — try again shortly.`,
      "dash.ins.t": `What your agent already saw`,
      "dash.ins.bron": `read: {m} emails · {e} calendar items`,
      "dash.ins.confirm": `Is this right?`,
      "dash.ins.reading": `Your agent is now reading your connected tools — this will appear here automatically…`,
      "dash.wiz.err.apppw": `That looks like your regular password. Use a 16-character app password — <a href="https://myaccount.google.com/apppasswords" target="_blank" rel="noopener">create one here →</a>`,
      "dash.hello": `Welcome`,
      "dash.badge": `Cockpit · being built`,
      "dash.sub": `Your VOI Agent is being set up from your audit. Below is exactly what we're building — and what still needs connecting.`,
      "dash.conn.t": `Connections`, "dash.conn.hint": `Connect your tools so your agent can use them`,
      "dash.conn.link": `Connect`, "dash.conn.soon": `Soon`,
      "dash.conn.note": `Connecting happens securely through the tool itself — your passwords never reach us.`,
      "dash.flows.t": `Workflows being built`, "dash.flows.hint": `What your agent takes off your plate`,
      "dash.flow.default": `Automate your workplace`, "dash.flow.building": `being built`,
      "dash.goal.t": `Your goal`,
      "dash.deep.t": `The deep audit`,
      "dash.deep.p": `Once your tools are connected, your agent reads your emails, documents and connected apps in detail — so it fully knows your business before it starts. You'll also be able to add a screen recording or a voice note to show or explain something.`,
      "dash.deep.apps": `App analysis`, "dash.deep.screen": `Screen recording`, "dash.deep.voice": `Voice`, "dash.deep.soon": `soon`,
      "dash.missing.h1": `Dashboard not found`,
      "dash.missing.p": `This link is expired or incomplete. Start your audit again and we'll make a fresh one.`,
      "dash.missing.cta": `To the audit`,
      "dash.loading": `Loading your dashboard…`,
      "start.ok.dash": `Open your dashboard`,
    ...
    fr: {
      ...
      "nav.dash": `Mon tableau de bord`, "foot2.l4": `Mon tableau de bord`,
      ...
      "wfs.lead": `Neuf exemples de ce qu'un VOI Agent exécute de bout en bout — construit sur vos processus.`,
      ...
      "wf7.tag": `Marketing`, "wf7.t": `Réseaux sociaux & contenu`, "wf7.p": `Des posts rédigés dans votre style, planifiés et suivis. Chaque semaine, sans que vous y pensiez.`,
      "wf8.tag": `Sur mesure`, "wf8.t": `Construit ses propres intégrations`, "wf8.p": `Il manque une connexion avec votre logiciel ? Votre agent la construit lui-même — c'est compris dans le service.`,
      "wf9.tag": `Legacy`, "wf9.t": `Travaille dans vos anciens logiciels`, "wf9.p": `Pas d'intégration possible ? Votre agent prend l'écran en main et travaille dans vos programmes habituels, comme le ferait un collègue.`,
      ...
      "dash.conn.ok": `Connecté`, "dash.conn.saved": `Clé enregistrée`,
      "dash.conn.replace": `Cliquez pour remplacer ou reconnecter`,
      "dash.conn.add": `Ajouter un outil`, "dash.conn.addname": `Nom de l'outil`, "dash.conn.next": `Suivant`,
      "dash.wiz.test": `Tester & connecter`, "dash.wiz.testing": `Test en cours…`,
      "dash.wiz.err": `La connexion a échoué — réessayez.`,
      "dash.wiz.email": `Adresse e-mail`, "dash.wiz.apppw": `Mot de passe d'application`,
      "dash.wiz.ics": `Lien iCal/ICS secret`, "dash.wiz.apikey": `Clé API`,
      "dash.wiz.help.gmail": `Utilisez un mot de passe d'application — pas votre mot de passe habituel (nous ne le demandons jamais). La validation en deux étapes doit être activée. <a href="https://myaccount.google.com/apppasswords" target="_blank" rel="noopener">Créez-en un ici →</a>`,
      "dash.wiz.help.outlook": `Utilisez un mot de passe d'application — pas votre mot de passe habituel (nous ne le demandons jamais). <a href="https://account.microsoft.com/security" target="_blank" rel="noopener">Créez-en un ici →</a>`,
      "dash.wiz.help.ics": `Collez le lien iCal secret de votre agenda — lecture seule, nous ne pouvons rien modifier. <a href="https://calendar.google.com/calendar/r/settings" target="_blank" rel="noopener">Trouvez-le dans les paramètres Google Agenda →</a>`,
      "dash.wiz.help.apikey": `Créez dans cet outil une clé API avec les droits les plus limités possible et collez-la ici. Votre agent ne l'utilise que pour vos workflows.`,
      "dash.login.h1": `Ouvrez votre tableau de bord`,
      "dash.login.p": `Saisissez l'adresse e-mail utilisée pour votre audit — vous recevrez immédiatement un code de connexion.`,
      "dash.login.email": `Adresse e-mail`, "dash.login.send": `Envoyer le code`,
      "dash.login.sent": `Si cette adresse est connue, un e-mail avec votre code est en route (valable 30 minutes).`,
      "dash.login.code": `Code de connexion (6 chiffres)`, "dash.login.verify": `Se connecter`,
      "dash.agent.t2": `Votre agent`, "dash.agent.concierge": `En construction`,
      "dash.plan.t": `Votre plan`, "dash.plan.portal": `Gérer votre abonnement`,
      "dash.plan.unlimited": `VOI Illimité — workflows et tâches cron illimités.`,
      "dash.plan.note": `{x} € sur 2 250 €/m — tout illimité au-delà.`,
      "dash.flows.t2": `Workflows`, "dash.flows.hint2": `Activez ce que votre agent peut reprendre`,
      "dash.wf.activate": `Activer`, "dash.wf.active": `Actif`, "dash.wf.pm": `/m`,
      "dash.wf.build": `Construire & tester — gratuit`, "dash.wf.inbuild": `En construction`,
      "dash.wf.review": `Approuver & activer`, "dash.wf.live": `En ligne`,
      "dash.werk.group": `L'agent a travaillé — {n} étapes`,
      "dash.think.1": `Lecture de votre message…`,
      "dash.think.2": `Réflexion en cours…`,
      "dash.think.3": `Rédaction de la réponse…`,
      "dash.think.4": `Un instant — c'est une longue…`,
      "dash.focus.on": `Focalisé sur '{w}'`,
      "dash.focus.ph": `À propos de '{w}' : tapez votre message…`,
      "dash.focus.close": `Fermer le focus`,
      "dash.ideas.aria": `Des idées pour votre agent`,
      "dash.ideas.t": `Sur quoi voulez-vous travailler ?`,
      "dash.ideas.hint": `Cliquez — votre agent s'en charge dans le chat.`,
      "dash.idea1.t": `Relancer les devis`, "dash.idea1.d": `Rien ne passe à la trappe`, "dash.idea1.p": `Construis un workflow qui relance automatiquement mes devis.`,
      "dash.idea2.t": `Traiter les factures`, "dash.idea2.d": `Lues et contrôlées`, "dash.idea2.p": `Construis un workflow qui traite et contrôle les factures entrantes.`,
      "dash.idea3.t": `Rapport hebdo & KPI`, "dash.idea3.d": `Prêt chaque lundi`, "dash.idea3.p": `Prépare automatiquement mon rapport hebdomadaire avec les chiffres chaque lundi.`,
      "dash.idea4.t": `Track & trace`, "dash.idea4.d": `Clients informés automatiquement`, "dash.idea4.p": `Envoie automatiquement une mise à jour aux clients quand le statut de leur commande change.`,
      "dash.idea5.t": `Leads & rendez-vous`, "dash.idea5.d": `Répondu dans la demi-heure`, "dash.idea5.p": `Capte les nouveaux leads et planifie automatiquement un rendez-vous.`,
      "dash.idea6.t": `Réseaux sociaux`, "dash.idea6.d": `Des posts dans votre style, à valider`, "dash.idea6.p": `Prépare chaque semaine des posts pour les réseaux sociaux dans notre style.`,
      "dash.idea7.t": `Intégration sur mesure`, "dash.idea7.d": `Votre agent la construit lui-même`, "dash.idea7.p": `Construis une intégration avec notre propre logiciel.`,
      "dash.idea8.t": `Anciens logiciels`, "dash.idea8.d": `Y travaille comme un collègue`, "dash.idea8.p": `Reprends des tâches dans notre ancien logiciel sans intégration.`,
      "dash.wf.payopened": `Page de paiement ouverte pour « {w} » — dès réception du paiement, il passe en ligne ici automatiquement.`,
      "dash.agent.t": `Discutez avec votre agent`,
      "dash.agent.live": `En direct`, "dash.agent.soon": `en cours d'activation`,
      "dash.agent.pending": `Votre agent est en cours de configuration et d'activation par VOI — le chat apparaîtra ici dès qu'il sera actif.`,
      "dash.agent.err": `Votre agent est momentanément injoignable — réessayez bientôt.`,
      "dash.ins.t": `Ce que votre agent a déjà vu`,
      "dash.ins.bron": `lu : {m} e-mails · {e} éléments d'agenda`,
      "dash.ins.confirm": `Est-ce correct ?`,
      "dash.ins.reading": `Votre agent lit maintenant vos outils connectés — cela apparaîtra ici automatiquement…`,
      "dash.wiz.err.apppw": `Cela ressemble à votre mot de passe habituel. Utilisez un mot de passe d'application de 16 caractères — <a href="https://myaccount.google.com/apppasswords" target="_blank" rel="noopener">créez-en un ici →</a>`,
      "dash.hello": `Bienvenue`,
      "dash.badge": `Cockpit · en construction`,
      "dash.sub": `Votre VOI Agent est en cours de configuration à partir de votre audit. Voici exactement ce que nous construisons — et ce qui reste à connecter.`,
      "dash.conn.t": `Connexions`, "dash.conn.hint": `Connectez vos outils pour que votre agent puisse les utiliser`,
      "dash.conn.link": `Connecter`, "dash.conn.soon": `Bientôt`,
      "dash.conn.note": `La connexion se fait en toute sécurité via l'outil lui-même — vos mots de passe ne nous parviennent jamais.`,
      "dash.flows.t": `Workflows en construction`, "dash.flows.hint": `Ce que votre agent vous enlève des mains`,
      "dash.flow.default": `Automatiser votre travail`, "dash.flow.building": `en construction`,
      "dash.goal.t": `Votre objectif`,
      "dash.deep.t": `L'audit approfondi`,
      "dash.deep.p": `Une fois vos outils connectés, votre agent lit vos e-mails, documents et apps connectées en détail — pour connaître pleinement votre entreprise avant de commencer. Vous pourrez aussi ajouter un enregistrement d'écran ou un message vocal pour montrer ou expliquer quelque chose.`,
      "dash.deep.apps": `Analyse des apps`, "dash.deep.screen": `Enregistrement d'écran`, "dash.deep.voice": `Voix`, "dash.deep.soon": `bientôt`,
      "dash.missing.h1": `Tableau de bord introuvable`,
      "dash.missing.p": `Ce lien est expiré ou incomplet. Recommencez votre audit et nous en créerons un nouveau.`,
      "dash.missing.cta": `Vers l'audit`,
      "dash.loading": `Chargement de votre tableau de bord…`,
      "start.ok.dash": `Ouvrir votre tableau de bord`,
