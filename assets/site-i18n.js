...
(function () {
  ...
  const DICT = {
    en: {
      ...
      "chat.agent": `VOI audit agent`, "chat.connecting": `Connecting…`, "chat.live": `Live`,
      "chat.ph": `Type your answer…`, "chat.send": `Send`,
      "chat.greet": `Hi! I'm VOI's audit agent. In a short conversation I'll map out how your business works, so your agent truly knows you before it starts. To begin: what's your company's name or website?`,
      "chat.pay.t": `Ready for the full audit`,
      "chat.pay.p": `The deep dive — every process, your team and goals, and after connecting, your agent reads your work environment in detail. €95, fully deducted from your onboarding.`,
      "chat.pay.cta": `Activate your audit — €95`,
      "chat.paid": `Payment received — let's continue.`,
      "chat.err": `The agent is briefly unreachable — try again or use the form below.`,
    ...
    fr: {
      ...
      "chat.agent": `Agent d'audit VOI`, "chat.connecting": `Connexion…`, "chat.live": `En direct`,
      "chat.ph": `Tapez votre réponse…`, "chat.send": `Envoyer`,
      "chat.greet": `Bonjour ! Je suis l'agent d'audit de VOI. En une courte conversation, je cartographie le fonctionnement de votre entreprise, pour que votre agent vous connaisse vraiment avant de commencer. Pour démarrer : quel est le nom ou le site web de votre entreprise ?`,
      "chat.pay.t": `Prêt pour l'audit complet`,
      "chat.pay.p": `L'analyse approfondie — tous les processus, votre équipe et vos objectifs, et après connexion, votre agent lit votre environnement de travail en détail. 95 €, entièrement déduits de votre onboarding.`,
      "chat.pay.cta": `Activez votre audit — 95 €`,
      "chat.paid": `Paiement reçu — continuons.`,
      "chat.err": `L'agent est momentanément injoignable — réessayez ou utilisez le formulaire ci-dessous.`,
