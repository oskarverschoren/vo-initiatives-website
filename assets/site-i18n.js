...
(function () {
  ...
  const DICT = {
    en: {
      ...
      "dash.wf.payopened": `Payment page opened for "{w}" — once payment arrives, I'll activate it here automatically.`,
    ...
    fr: {
      ...
      "dash.wf.payopened": `Page de paiement ouverte pour « {w} » — dès réception du paiement, je l'active ici automatiquement.`,
